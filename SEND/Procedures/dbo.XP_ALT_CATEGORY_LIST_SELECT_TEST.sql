...
/*================================================================================================================
■ USP_NAME					: XP_ALT_CATEGORY_LIST_SELECT_TEST
■ DESCRIPTION				: 알림톡 메세지 템플릿 검색
■ INPUT PARAMETER			: 
■ OUTPUT PARAMETER			: 
■ EXEC						: 	
	SELECT * FROM NVMOBILECONTENTS WHERE KAKAO_TMPL_CD LIKE 'ERP_MA_%'	
	EXEC XP_ALT_CATEGORY_LIST_SELECT_TEST '', 'ERP_MA_0003,ERP_MA_0004'
	EXEC XP_ALT_CATEGORY_LIST_SELECT_TEST 'MANUAL', '', 'DEV_ERP_MA_0021'
	EXEC XP_ALT_CATEGORY_LIST_SELECT_TEST 'MANUAL', '', '여권'
	EXEC XP_ALT_CATEGORY_LIST_SELECT_TEST 'RESERVE,PASSPORT,PRODUCT,PAY,AIR,GUIDE,VISA', '', '발급'
■ MEMO						: 
------------------------------------------------------------------------------------------------------------------
■ CHANGE HISTORY                   
------------------------------------------------------------------------------------------------------------------
...
================================================================================================================*/ 
CREATE PROCEDURE [dbo].[XP_ALT_CATEGORY_LIST_SELECT_TEST]
...
BEGIN
	...
	SELECT @WHERE = @WHERE + ' AND A.KAKAO_INSP_STATUS IN (''REQ'', ''APR'') AND A.KAKAO_TMPL_STATUS IN (''A'', ''R'')'
