...
GO
/*================================================================================================================
■ USP_NAME					: XP_ALT_MESSAGE_SMSDIFF_INSERT
■ DESCRIPTION				: 알림톡 발송 메세지 등록 (문자 형식 다를 경우)
■ INPUT PARAMETER			: 
■ OUTPUT PARAMETER			: 
■ EXEC						: 
■ MEMO						: 
...
================================================================================================================*/ 
CREATE PROCEDURE [dbo].[XP_ALT_MESSAGE_SMSDIFF_INSERT]
	...
	@SMS_SND_MSG	NVARCHAR(2000),     -- [문자 보내는 경우 템플릿과 다른 내용 발송]
...
BEGIN
	...
	-- 메세지 본문 등록
	INSERT INTO SEND.dbo.MZSENDTRAN ( SN, SENDER_KEY, CHANNEL, SND_TYPE, PHONE_NUM, TMPL_CD, SND_MSG, SMS_SND_MSG , REQ_DTM,  SUBJECT, SMS_SND_NUM, REQ_DEPT_CD, REQ_USR_ID, SMS_SND_YN, TR_TYPE_CD ,ATTACHMENT )
	VALUES (
		@SN,			-- [발송요청ID]
		...
		@SMS_SND_MSG,   -- [문자 보내는 경우 템플릿과 다른 내용 발송]
