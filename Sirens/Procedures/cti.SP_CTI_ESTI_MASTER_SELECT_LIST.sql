...
GO
/*================================================================================================================
■ USP_NAME					: SP_CTI_ESTI_MASTER_SELECT_LIST
■ DESCRIPTION				: 직원평가 리스트 조회
■ INPUT PARAMETER			: 
@ESTI_WOL	CHAR(6), : 평가월
	@SHEET_CODE	INT,	: 평가쉬트지코드
	@TEAM_CODE	VARCHAR(3) : 팀코드
■ OUTPUT PARAMETER			: 
■ EXEC						: EXEC SP_CTI_ESTI_MASTER_SELECT_LIST
■ MEMO						: 
------------------------------------------------------------------------------------------------------------------
■ CHANGE HISTORY                   
------------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------------------------
   2015-01-10		곽병삼			최초생성
================================================================================================================*/ 
CREATE PROCEDURE [cti].[SP_CTI_ESTI_MASTER_SELECT_LIST]
--DECLARE
	@ESTI_WOL	CHAR(6),
	@SHEET_CODE	INT,
	@TEAM_CODE	VARCHAR(3)
...
FROM Sirens.cti.CTI_ESTI_MASTER ESTI, Diablo.dbo.EMP_MASTER EMP, Diablo.dbo.EMP_TEAM TEAM, Diablo.dbo.EMP_MASTER EMP2, Sirens.cti.CTI_ESTI_SHEET SHEET
