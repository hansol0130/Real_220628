...
/*================================================================================================================
■ USP_NAME					: SP_CTI_PROMISE_CHART_SELECT
...
■ EXEC						: 
	...
	exec SP_CTI_PROMISE_CHART_SELECT
...
================================================================================================================*/ 
CREATE PROCEDURE [cti].[SP_CTI_PROMISE_CHART_SELECT]
...
BEGIN
  ...
  ORDER BY SUM(IN_CUST_COUNT) + SUM(IN_CALL_COUNT) desc -- , A.TEAM_NAME    
