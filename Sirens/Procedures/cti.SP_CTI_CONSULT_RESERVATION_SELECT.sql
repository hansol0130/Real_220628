...
/*================================================================================================================
■ USP_NAME					: SP_CTI_CONSULT_RESERVATION_SELECT
...
■ EXEC						: 
	...
	exec CTI.SP_CTI_CONSULT_RESERVATION_SELECT 1,20, '', '' , '2014-02-02','2014-06-06','0','A','',''
...
------------------------------------------------------------------------------------------------------------------
   ...
   2018-03-08		정지용			고객 등급 추가
   2020-12-09		김성호			고객 등급 위치 변경
================================================================================================================*/ 



CREATE PROCEDURE [cti].[SP_CTI_CONSULT_RESERVATION_SELECT]
...
SET NOCOUNT ON
	...
	SET @SQL = '	
		...
		FROM (' + @BSQL + ')T1
		LEFT JOIN DIABLO..CUS_VIP_HISTORY B WITH(NOLOCK) ON T1.CUS_NO = B.CUS_NO AND B.VIP_YEAR = ' + CONVERT(VARCHAR(4), YEAR(GETDATE())) + '
