...
/*================================================================================================================    
■ USP_NAME     : ZP_WEB_RES_MASTER_LIST_SELECT    
...
declare @p6 int    
set @p6=157    
exec ZP_WEB_RES_MASTER_LIST_SELECT @PRO_TYPE=0,@CUS_NO=4797216,@PAGE_INDEX=1,@PAGE_SIZE=13,@ORDER_BY=1,@TOTAL_COUNT=@p6 output    
select @p6    
GO     
...
declare @p6 int    
set @p6=157    
exec ZP_WEB_RES_MASTER_LIST_SELECT @PRO_TYPE=9,@CUS_NO=3822821,@PAGE_INDEX=1,@PAGE_SIZE=100,@ORDER_BY=1,@TOTAL_COUNT=@p6 output    
select @p6    
...
------------------------------------------------------------------------------------------------------------------    
   ...
   2020-02-15  임검제   최근 수정일 확인을 위하여 EDT_DATE SELECT 추가   
================================================================================================================*/     
CREATE PROC [dbo].[ZP_WEB_RES_MASTER_LIST_SELECT]    
 @CUS_NO   INT,    
