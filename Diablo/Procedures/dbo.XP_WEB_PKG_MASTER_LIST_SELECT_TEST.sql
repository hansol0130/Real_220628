...
■ EXEC						: 
	...
	SELECT @PAGE_INDEX=1,@PAGE_SIZE=90,@KEY=N'Provider=0&BrandType=&RegionCode=&CityCode=&NationCode=&AttCode=&GroupCode=&MinPrice=&MaxPrice=&DepDate=&Day=&BranchCode=1&Keyword=',@ORDER_BY=4
...
CREATE  PROCEDURE [dbo].[XP_WEB_PKG_MASTER_LIST_SELECT_TEST]
(
	@PAGE_INDEX  INT,
	@PAGE_SIZE  INT,
...
BEGIN
	...
	SELECT
		A.MASTER_CODE, A.MASTER_NAME, A.PKG_COMMENT, A.PKG_SUMMARY, A.LOW_PRICE, A.HIGH_PRICE, A.EVENT_NAME, A.NEXT_DATE
		, A.EVENT_PRO_CODE, A.EVENT_DEP_DATE, A.ATT_CODE, A.BRANCH_CODE, A.SIGN_CODE, A.BRAND_TYPE
		, DBO.FN_GET_TOUR_NIGHY_DAY_TEXT(A.MASTER_CODE,1) AS TOUR_NIGHT_DAY
