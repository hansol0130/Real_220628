...
GO
/*================================================================================================================          
■ USP_NAME     : [ZP_MOV2_PUB_SALE_PRODUCT_LIST_SELECT]          
■ DESCRIPTION    : 주말 할인 상품 리스트.          
■ INPUT PARAMETER   : @VR_NO@VR_NAME @VR_DESC @VR_CREATOR @nowPage           
■ EXEC      :            
    -- [ZP_MOV2_PUB_SALE_PRODUCT_LIST_SELECT]               
DECLARE @TotalCount INT          
EXEC [ZP_MOV2_PUB_SALE_PRODUCT_LIST_SELECT] '2016-10-28', 1, 10, @TotalCount OUT, 'VGT', 'J'          
SELECT @TotalCount          
■ MEMO      : 주말 할인 상품 리스트.          
------------------------------------------------------------------------------------------------------------------          
■ CHANGE HISTORY                               
...
------------------------------------------------------------------------------------------------------------------          
   ...
   2020-02-18	임원묵			SP_MOV2_PUB_SALE_PRODUCT_LIST_SELECT -> ZP_MOV2_PUB_SALE_PRODUCT_LIST_SELECT 로 복사 생성
================================================================================================================*/           
CREATE PROCEDURE [dbo].[ZP_MOV2_PUB_SALE_PRODUCT_LIST_SELECT] 
