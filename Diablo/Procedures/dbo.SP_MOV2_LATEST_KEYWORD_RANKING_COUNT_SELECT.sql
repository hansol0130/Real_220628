...
GO
/*================================================================================================================
■ USP_NAME					: SP_MOV2_LATEST_KEYWORD_RANKING_COUNT_SELECT
■ DESCRIPTION				: 검색_최신키워드랭킹갯수_ALL
■ INPUT PARAMETER			: 
■ EXEC						: 
    -- EXEC SP_MOV2_LATEST_KEYWORD_RANKING_COUNT_SELECT '2017-09-28', '2017-10-05', 0

■ MEMO						: 검색_최신키워드랭킹갯수_ALL
------------------------------------------------------------------------------------------------------------------
■ CHANGE HISTORY                   
------------------------------------------------------------------------------------------------------------------
...
================================================================================================================*/ 
CREATE PROCEDURE [dbo].[SP_MOV2_LATEST_KEYWORD_RANKING_COUNT_SELECT]
