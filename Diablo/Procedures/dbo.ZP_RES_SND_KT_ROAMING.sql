...
/*================================================================================================================
■ USP_NAME					: ZP_RES_SND_KT_ROAMING
■ DESCRIPTION				: KT로밍에그 난수번호 알림톡 발송의 건 REFS #1510
■ INPUT PARAMETER			: 
■ OUTPUT PARAMETER			: 
■ EXEC						: 
...
------------------------------------------------------------------------------------------------------------------
   2021-08-18		오준혁			최초생성
================================================================================================================*/ 
CREATE PROCEDURE [dbo].[ZP_RES_SND_KT_ROAMING]
AS 
BEGIN
	...
	/*
	 *
		1. 발송 대상: 추석 전세기 상품 출발 고객 (* 해당하는 상품코드 첨부)
		             - 로밍에그 쿠폰번호는 대표 예약자에게 발송됩니다.
		2. 발송 시점: 2021년 9월 15일 일괄 발송
		3. 템플릿 : SYS_AT_0162	
	 ...
	 * 알림톡 정보
	 */
	DECLARE @TMPL_CD       VARCHAR(20) = 'SYS_AT_0162'	-- 사용 템플릿 번호
	...
	WHERE c.MASTER_CODE IN (
		'EPP3989','EPP3105','EPP4104','EPP4721','EPP5551','EPP5088','EPP2379','EPP2209'
		,'UPP173','UPP175','UPP154'
		,'IPC563','IPG563','IPC567','IPG567','IPP086','IPP087'
		,'APP123','APP129','APP117','APP118'
		,'JPP0168','JPG501','JPG1019','JPG118'
		,'APP0662','APP0668','APP8021','APP0566'
		,'EPP3989','EPP3015','EPP2003'
		,'IPP191','IPP192'
		,'UPF6013','UPF6016'
		,'APP128','APP1141','APP0123','APP0143','APP3003'
	)		
	AND a.RES_STATE < 7
	AND b.RES_STATE = 0
	AND a.DEP_DATE >= '2021-09-17' AND a.DEP_DATE < '2021-09-20'
