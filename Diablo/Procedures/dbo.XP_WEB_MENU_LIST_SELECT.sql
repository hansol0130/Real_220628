...
GO
/*================================================================================================================
■ USP_NAME					: XP_WEB_MENU_LIST_SELECT
...
■ EXEC						: 
	...
	exec XP_WEB_MENU_LIST_SELECT 'VGT', '102', 'N'
...
CREATE  PROCEDURE [dbo].[XP_WEB_MENU_LIST_SELECT]
(
	@SITE_CODE	VARCHAR(3),
...
BEGIN
	...
	LEFT JOIN ' + @TABLE_NAME + N' C WITH(NOLOCK) ON C.MENU_CODE = SUBSTRING(A.MENU_CODE, 1, 5) -- 항상 1레벨의 값을 가진다.
	WHERE A.USE_YN = ''Y''
