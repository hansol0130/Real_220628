...
/*================================================================================================================
■ USP_NAME					: SP_PKG_GMARKET_SEAT_INFO_SELECT
■ DESCRIPTION				: G마켓 상품 잔여 좌석 조회
■ INPUT PARAMETER			: 
...
■ EXEC						: 
 ...
 exec SP_PKG_GMARKET_SEAT_INFO_SELECT 'PPP235-140715TH', 1
...
================================================================================================================*/ 
CREATE PROC [dbo].[SP_PKG_GMARKET_SEAT_INFO_SELECT]
	@PRO_CODE VARCHAR(20),
	@PRICE_SEQ INT
AS 
BEGIN
	...
	BEGIN
		WITH LIST AS
		(
			SELECT (A.PRO_CODE + '|' + CONVERT(VARCHAR(2), B.PRICE_SEQ)) AS [SERIES_NO]
		...
		SELECT A.SERIES_NO, (RSV_REMAIN_CNT - (RES_COUNT+FAKE_COUNT)) AS [REMAIN_SEAT]
