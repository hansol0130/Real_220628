...
GO
/*================================================================================================================
■ USP_NAME					: SP_MOV2_MOB_PKG_MASTER_SELECT
...
■ EXEC						: 
	...
	exec SP_MOV2_MOB_PKG_MASTER_SELECT 'EPF002'
...
------------------------------------------------------------------------------------------------------------------
   2013-10-08		김성호			최초생성
   2017-07-12		오준욱			사진정보 4장까지 / 관련 기획전 갯수 / 관련 이벤트 갯수
================================================================================================================*/ 

CREATE  PROCEDURE [dbo].[SP_MOV2_MOB_PKG_MASTER_SELECT]
(
