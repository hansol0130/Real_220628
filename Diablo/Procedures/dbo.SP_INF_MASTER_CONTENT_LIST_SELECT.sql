...
/*================================================================================================================
■ USP_NAME					: SP_INF_MASTER_CONTENT_LIST_SELECT
■ DESCRIPTION				: 일정등록 컨텐츠 리스트 검색
■ INPUT PARAMETER			: 
■ OUTPUT PARAMETER			:   
 기존 SP_INF_MASTER_LIST_SELECT의 KOR TITLE에 지역코드 매칭이 있는데 영향도 파악 불가로 해당 리스트 검색 생성
...
CREATE PROCEDURE [dbo].[SP_INF_MASTER_CONTENT_LIST_SELECT]
	@FLAG			char(1),
	@PAGE_SIZE		int	= 10,
	@PAGE_INDEX		int = 0,	
	@REGION_CODE	char(3),
