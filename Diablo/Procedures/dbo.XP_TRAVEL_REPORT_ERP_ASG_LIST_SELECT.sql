...
/*================================================================================================================
■ USP_NAME					: XP_TRAVEL_REPORT_ERP_ASG_LIST_SELECT
■ DESCRIPTION				: ERP 인솔자관리 출장보고서현황 리스트 검색
■ INPUT PARAMETER			: 
...
■ EXEC						: 
	...
	exec XP_TRAVEL_REPORT_ERP_ASG_LIST_SELECT @page_index, @page_size, @total_count output, @key, @order_by
	SELECT @TOTAL_COUNT
■ MEMO						: 
------------------------------------------------------------------------------------------------------------------
■ CHANGE HISTORY                   
...
------------------------------------------------------------------------------------------------------------------
   2019-04-15		이명훈			XP_ASG_EVT_REPORT_LIST_SELECT_2(OTR_MASTER => TRAVEL_REPORT_MASTER)    
================================================================================================================*/ 

CREATE  PROCEDURE [dbo].[XP_TRAVEL_REPORT_ERP_ASG_LIST_SELECT]
(
	@PAGE_INDEX  INT,
	@PAGE_SIZE  INT,
