...
GO
/*================================================================================================================    
■ USP_NAME     : ZP_WEB_MENU_ITEM_PACKGAGE_LIST_SELECT    
...
■ EXEC      :     
 ...
 exec ZP_WEB_MENU_ITEM_PACKGAGE_LIST_SELECT 'VGT', '10206', '2', 5, 'D'    
...
------------------------------------------------------------------------------------------------------------------    
   ...
   2020-02-18  임원묵   XP_WEB_MENU_ITEM_PACKGAGE_LIST_SELECT -> ZP_WEB_MENU_ITEM_PACKGAGE_LIST_SELECT 로 복사 생성
   2020-11-23  김영민	CLEAN_YN 컬럼추가
================================================================================================================*/     

CREATE PROCEDURE [dbo].[ZP_WEB_MENU_ITEM_PACKGAGE_LIST_SELECT] 
(@SITE_CODE VARCHAR(3) ,@MENU_CODE VARCHAR(20) ,@SEC_CODE VARCHAR(4) ,@TOP_COUNT INT ,@ORDER_BY VARCHAR(1))
AS
BEGIN
	...
	BEGIN
	    ...
	    BEGIN
	        IF EXISTS(
	               SELECT 1
	               FROM   MNU_MNG_SECTION WITH(NOLOCK)
 ...
 SELECT ';  
	SET @SQLSTRING = @SQLSTRING + (CASE @TOP_COUNT WHEN 0 THEN '' ELSE 'TOP (@TOP_COUNT) ' END) + 
	    N'    
