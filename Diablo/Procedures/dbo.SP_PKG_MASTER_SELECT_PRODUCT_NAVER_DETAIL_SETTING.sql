...
SP_PKG_MASTER_SELECT_PRODUCT_NAVER_DETAIL_SETTING 'JPP4850-200420|1' , NULL , NULL , 2  

SP_PKG_MASTER_SELECT_PRODUCT_NAVER_DETAIL_SETTING 'JPP4850' , 'JPP4850-200420|1' , NULL , 2 

SP_PKG_MASTER_SELECT_PRODUCT_NAVER_DETAIL_SETTING 'APP5010' , 'APP5010-191205KE|1' , NULL , 1 
SP_PKG_MASTER_SELECT_PRODUCT_NAVER_DETAIL_SETTING 'APP5010' , 'APP5010-191205KE|1' , NULL , 1 
...
2019-12-23			박형만			신규로직 반영, 조회/등록 모드 선택 PROCESS_MODE 가능 하도록 , basedate 추가 
================================================================================================================*/ 
CREATE  PROC [dbo].[SP_PKG_MASTER_SELECT_PRODUCT_NAVER_DETAIL_SETTING]
...
--F.SEAT_CODE ,
		...
		CASE WHEN F.TRANS_TYPE=2 THEN CONVERT(DATETIME,CONVERT(VARCHAR(10), B.ARR_DATE, 120)  + ' ' + F.ARR_ARR_TIME + ':00') END AS endShip_arriveDate,--
	...
	(CASE WHEN B.SHOW_YN = 'N' OR C.SHOW_YN ='N' OR B.RES_ADD_YN = 'N'  THEN 'RSVCD' WHEN B.MAX_COUNT < 0 THEN 'ARBKG' WHEN B.DEP_CFM_YN IN( 'Y','F') THEN 'LEVDC' ELSE 'RSVPS' END) AS bookingStatus_bookingCode,
...
PRINT '3.임시테이블 -> 실제테이블 이동' 
	...
	BEGIN
		...
		-- 새로 등록 
		INSERT INTO NAVER_PKG_DETAIL_OPTION
