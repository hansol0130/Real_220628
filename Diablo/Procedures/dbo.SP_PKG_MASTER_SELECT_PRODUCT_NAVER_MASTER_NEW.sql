...
/*================================================================================================================
■ USP_NAME					: SP_PKG_MASTER_SELECT_PRODUCT_NAVER_MASTER_NEW
■ DESCRIPTION				: 2019 네이버 패키지 상품연동 마스터 조회 ( 테스트 ) 
■ INPUT PARAMETER			: 
■ OUTPUT PARAMETER			: 
■ EXEC						: SP_PKG_MASTER_SELECT_PRODUCT_NAVER_MASTER_NEW 'XPP3019'
...
================================================================================================================*/ 
create  PROC [dbo].[SP_PKG_MASTER_SELECT_PRODUCT_NAVER_MASTER_NEW]
	@CODE VARCHAR(30)
AS
BEGIN
