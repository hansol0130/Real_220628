...
CREATE PROCEDURE [dbo].[SP_PKG_DETAIL_SELECT_LIST_4]  
...
BEGIN  
 ...
 PRINT @SQLSTRING  
 EXEC SP_EXECUTESQL @SQLSTRING, @PARMDEFINITION, @MASTER_CODE, @PRO_CODE, @TEAM_CODE, @START, @END, @ATT_CODE, @RES_YN, @REGION_CODE  
END  
