...
GO
/*================================================================================================================        
■ USP_NAME     : SP_PKG_URGENT_PRODUCT_REGION_COUNT        
■ DESCRIPTION    : 긴급모객 상품 지역 카운트        
■ INPUT PARAMETER   :         
■ OUTPUT PARAMETER   :         
■ EXEC      :         
 EXEC SP_PKG_URGENT_PRODUCT_REGION_COUNT 'VGT'        
■ MEMO      :         
------------------------------------------------------------------------------------------------------------------        
■ CHANGE HISTORY                           
------------------------------------------------------------------------------------------------------------------        
...
------------------------------------------------------------------------------------------------------------------        
   ...
   2020-02-24	김성호		SITE_CODE DEFAULT 설정 및 리턴 시 빈값 삭제 
================================================================================================================*/         
CREATE PROCEDURE [dbo].[SP_PKG_URGENT_PRODUCT_REGION_COUNT] 
(
	@SITE_CODE CHAR(3) = 'VGT'
)
AS
BEGIN
