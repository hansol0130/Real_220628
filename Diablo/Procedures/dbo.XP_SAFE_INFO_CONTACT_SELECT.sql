...
/*================================================================================================================
■ USP_NAME					: XP_SAFE_INFO_CONTACT_SELECT
■ DESCRIPTION				: 안전정보 현지연락처 조회
■ INPUT PARAMETER			: 
■ OUTPUT PARAMETER			: 
■ EXEC						: 	
	EXEC XP_SAFE_INFO_CONTACT_SELECT ''
	EXEC XP_SAFE_INFO_CONTACT_SELECT 'HUN,ICN,TPE, FJG, HEK'
■ MEMO						: 
------------------------------------------------------------------------------------------------------------------
■ CHANGE HISTORY                   
------------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------------------------
   2016-01-06		정지용			최초생성
================================================================================================================*/ 
CREATE PROC [dbo].[XP_SAFE_INFO_CONTACT_SELECT]
...
BEGIN
	...
	SELECT 
		CONTINENT, COUNTRY_NAME, COUNTRY_EN_NAME, CONTACT, IMG_URL1, IMG_URL2, WRT_DT
	FROM SAFE_INFO_CONTACT A WITH(NOLOCK)
