...
GO
/*================================================================================================================
■ USP_NAME					: XP_COM_BIZTRIP_REGION_EDITOR_SELECT
■ DESCRIPTION				: BTMS 거래처 관리 지역 최종 수정자 검색
■ INPUT PARAMETER			: 
	@AGT_CODE				: 거래처코드
■ OUTPUT PARAMETER			: 
■ EXEC						: 

	EXEC DBO.XP_COM_BIZTRIP_REGION_EDITOR_SELECT 93851
...
------------------------------------------------------------------------------------------------------------------
   2016-02-26		김성호			최초생성
   2016-05-09		이유라			INNER JOIN -> LEFT JOIN 변경
================================================================================================================*/ 
CREATE PROC [dbo].[XP_COM_BIZTRIP_REGION_EDITOR_SELECT]
	@AGT_CODE		VARCHAR(10)
AS 
BEGIN
	...
	(
		...
		FROM COM_REGION_MASTER WITH(NOLOCK)
