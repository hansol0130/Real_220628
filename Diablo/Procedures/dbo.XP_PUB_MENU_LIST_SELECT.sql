...
GO
/*================================================================================================================
■ USP_NAME					: XP_PUB_MENU_LIST_SELECT
...
■ EXEC						: 
	...
	exec XP_PUB_MENU_LIST_SELECT 'VGT', '117', 'Y'
...
------------------------------------------------------------------------------------------------------------------
   2013-04-18		김성호			최초생성
   2013-05-02		김성호			XP_WEB_MENU_LIST_SELECT 에서 이름 변경
   2013-06-10		김성호			WITH(NOLOCK) 추가
================================================================================================================*/ 

CREATE  PROCEDURE [dbo].[XP_PUB_MENU_LIST_SELECT]
(
	@SITE_CODE	VARCHAR(3),
