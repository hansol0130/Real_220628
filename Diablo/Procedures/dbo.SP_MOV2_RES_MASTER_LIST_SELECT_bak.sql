...
declare @p6 int
set @p6=157
exec SP_MOV2_RES_MASTER_LIST_SELECT @PRO_TYPE=0,@CUS_NO=4228549,@PAGE_INDEX=1,@PAGE_SIZE=10,@ORDER_BY=1,@TOTAL_COUNT=@p6 output
select @p6
...
================================================================================================================*/ 
CREATE PROC [dbo].[SP_MOV2_RES_MASTER_LIST_SELECT_bak]
	@CUS_NO			INT,
