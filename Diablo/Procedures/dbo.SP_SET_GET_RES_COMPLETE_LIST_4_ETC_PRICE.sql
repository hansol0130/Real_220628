...
-- 2017-01-10	김성호	산술오버풀로로 인해 컨버팅 형식 int -> float 로 변환
-- =============================================
CREATE PROCEDURE [dbo].[SP_SET_GET_RES_COMPLETE_LIST_4_ETC_PRICE]
(
@DATE_TYPE	INT,
@EMP_TYPE	INT,
@START_DATE	DATETIME,
...
FROM ( SELECT 
				...
				PROFIT_TEAM_NAME,
				DEP_DATE,
				CONVERT(FLOAT,DBO.FN_SET_GET_PRO_PERSON_PROFIT(A.PRO_CODE)) PROFIT
				FROM 
				(       
									-- PROFIT_TYPE_3
									SELECT
