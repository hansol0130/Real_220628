...
SP_FAX_MASTER_SEARCH_LIST @SEARCH_TYPE=0,@TEAM_CODE=N'512',@EMP_CODE=NULL,@SUBJECT=NULL,@START_DATE=N'2012-03-01',@END_DATE=N'2012-05-31',@FAX_CAT_SEQ=0,@PAGE_SIZE=15,@PAGE_INDEX=0

-- 2012-03-02 박형만 WITH(NOLOCK) 추가 	
-- 2012-05-21 쿼리 튜닝 SP_EXECUTESQL 로 수정,   ORDER BY A.NEW_DATE --> A.FAX_SEQ !
-- ========================================================================= */ 
CREATE PROCEDURE [dbo].[SP_FAX_MASTER_SEARCH_LIST]
