...
GO
/*================================================================================================================
■ USP_NAME					: XP_WEB_CUS_INTEREST_SELECT
...
■ EXEC						: 
	...
	exec XP_WEB_CUS_INTEREST_SELECT @page_index, @page_size, @cus_no, @total_count output
	SELECT @TOTAL_COUNT
■ MEMO						: 
-----------------------------------------------------------------------------------------------------------------
■ CHANGE HISTORY                   
...
================================================================================================================*/ 
CREATE PROCEDURE [dbo].[XP_WEB_CUS_INTEREST_SELECT]
(
	@PAGE_INDEX  INT,
	@PAGE_SIZE  INT,
	@CUS_NO		INT,
...
BEGIN
	...
	(
		...
		SELECT INTE.INT_SEQ, INTE.PRO_CODE,
			MST.PKG_COMMENT,
			IMG.FILE_CODE, IMG.REGION_CODE, IMG.NATION_CODE, IMG.STATE_CODE, IMG.CITY_CODE, IMG.FILE_NAME_S, 
