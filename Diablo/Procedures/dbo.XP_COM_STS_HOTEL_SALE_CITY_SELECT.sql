...
GO
/*================================================================================================================
■ USP_NAME					: XP_COM_STS_HOTEL_SALE_CITY_SELECT
■ DESCRIPTION				: ERP BTMS 호텔 도시별 매출현황
■ INPUT PARAMETER			: 
	@KEY		VARCHAR(400): 검색 키
■ OUTPUT PARAMETER			: 
■ EXEC						: 

	EXEC DBO.XP_COM_STS_HOTEL_SALE_CITY_SELECT 'AgentCode=92756&TeamSeq=&EmpSeq=125&StartDate=2016-06-01&EndDate=2016-09-30&OrderType='
...
------------------------------------------------------------------------------------------------------------------
   2016-06-14	 저스트고_강태영	  최초생성
================================================================================================================*/ 
CREATE PROC [dbo].[XP_COM_STS_HOTEL_SALE_CITY_SELECT]
...
BEGIN
	...
	SET @SQLSTRING = N'
		...
		' + @WHERE + N'
		GROUP BY F.KOR_NAME, G.KOR_NAME '
		+ @ORDERBY
