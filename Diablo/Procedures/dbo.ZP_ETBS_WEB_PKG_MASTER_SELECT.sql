...
/*================================================================================================================                                                        
■ USP_NAME				: ZP_ETBS_WEB_PKG_MASTER_SELECT ( <= XP_WEB_PKG_MASTER_LIST_SELECT 에 정렬방식 추가)                                                         
...
------------------------------------------------------------------------------------------------------------------
	2021-09-08	EHD(김영민)	AND A.SIGN_CODE <> ''K''  이제너두 제휴사 국내제외
================================================================================================================*/                                                         
CREATE  PROCEDURE [dbo].[ZP_ETBS_WEB_PKG_MASTER_SELECT]                                                
(                                                        
	 @PAGE_INDEX  INT,                                                        
	 @PAGE_SIZE  INT,                                                        
...
BEGIN
	...
	'                                                        
	--print @TOTAL_COUNT                                                        
	SET @SQLSTRING = @SQLSTRING + N'' + @WHERE + 'AND A.SIGN_CODE <> ''K''';   
