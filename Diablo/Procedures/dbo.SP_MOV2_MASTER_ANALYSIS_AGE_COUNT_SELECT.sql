...
/*================================================================================================================
■ USP_NAME					: SP_MOV2_MASTER_ANALYSIS_AGE_COUNT_SELECT
■ DESCRIPTION				: 검색_마스터별_연령대분석_행수
■ INPUT PARAMETER			: 
■ EXEC						: 
    -- EXEC SP_MOV2_MASTER_ANALYSIS_AGE_COUNT_SELECT '2017-09-28', '2017-10-05', '', ''
...
================================================================================================================*/ 
CREATE PROCEDURE [dbo].[SP_MOV2_MASTER_ANALYSIS_AGE_COUNT_SELECT]
