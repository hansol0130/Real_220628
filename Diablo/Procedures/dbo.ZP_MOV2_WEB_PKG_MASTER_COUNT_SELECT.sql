...
GO
/*================================================================================================================        
■ USP_NAME     : ZP_MOV2_WEB_PKG_MASTER_COUNT_SELECT         
...
■ EXEC      :         
 ...
 exec ZP_MOV2_WEB_PKG_MASTER_COUNT_SELECT @total_count output, @key        
...
------------------------------------------------------------------------------------------------------------------        
   ...
   2019-12-17  임검제   2019 리뉴얼 추가    
    ...
    PRICE 금액   
	2020-02-18	임원묵			SP_MOV2_WEB_PKG_MASTER_COUNT_SELECT -> ZP_MOV2_WEB_PKG_MASTER_COUNT_SELECT 로 복사 생성	
    
================================================================================================================*/         
CREATE PROCEDURE [dbo].[ZP_MOV2_WEB_PKG_MASTER_COUNT_SELECT] 
