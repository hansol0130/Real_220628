...
GO
/*================================================================================================================
■ USP_NAME					: SP_FAX_MASTER_LIST_SELECT_TEST
...
------------------------------------------------------------------------------------------------------------------
   ...
   2015-10-28		정지용			쿼리 튜닝 ( FAX_RECEIVE에 강제 인덱스 추가 - 동적쿼리에서 인덱스를 안타는 현상때문에 )
================================================================================================================*/ 
CREATE PROCEDURE [dbo].[SP_FAX_MASTER_LIST_SELECT_TEST]
	@PAGE_INDEX INT,
	@PAGE_SIZE INT,
...
BEGIN	
	...
	SET @STR_QUERY = N'
		...
		INNER JOIN FAX_RECEIVE B WITH(NOLOCK) ON A.FAX_SEQ = B.FAX_SEQ AND A.FAX_TYPE = 2 AND A.DEL_YN=''N''
		' + @STR_WHERE + N';
