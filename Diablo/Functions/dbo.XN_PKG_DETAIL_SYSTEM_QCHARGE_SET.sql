...
GO
/*-------------------------------------------------------------------------------------------------
■ Function_Name			: XN_PKG_DETAIL_SYSTEM_QCHARGE_SET
...
-------------------------------------------------------------------------------------------------*/ 
CREATE FUNCTION [dbo].[XN_PKG_DETAIL_SYSTEM_QCHARGE_SET]
(	
	@PKG_DETAIL UDT_PKG_DETAIL READONLY
)
RETURNS TABLE
AS
RETURN
(
	...
	SELECT AA.PRO_CODE, T2.[QCHARGE_DATE], ISNULL(T2.[ADT_QCHARGE], 0) AS [ADT_QCHARGE], ISNULL(T2.[CHD_QCHARGE], 0) AS [CHD_QCHARGE], ISNULL(T2.[INF_QCHARGE], 0) AS [INF_QCHARGE]
	FROM LIST AA
	OUTER APPLY (
