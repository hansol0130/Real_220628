...
GO
CREATE FUNCTION [dbo].[FN_RES_HTL_GET_PAY_STATE]
(
	@RES_CODE VARCHAR(20)
)
RETURNS INT
...
BEGIN
	...
	-- TOT_PRICE는 판매액
	SELECT @TOT_PRICE = DBO.FN_RES_HTL_GET_TOTAL_PRICE(@RES_CODE)

	-- PAY_PRICE는 입금액
	SELECT @PAY_PRICE = DBO.FN_RES_GET_PAY_PRICE(@RES_CODE)
