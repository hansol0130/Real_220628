...
GO
CREATE PROC [dbo].[USP_HTL_SALE_CUSTOMER_COUNT2]
    
/*    
USP_HTL_SALE_CUSTOMER_COUNT2 'C', 'ADULT_CNT', '2014-06-01', '2014-08-30'    
*/    
...
SET @SQL = @SQL + '  ADULT_CNT, ' + CHAR(13)    
SET @SQL = @SQL + '  CHILD_CNT, ' + CHAR(13)    
...
SET @SQL = @SQL + ' GROUP BY ADULT_CNT, CHILD_CNT ' + CHAR(13)    
