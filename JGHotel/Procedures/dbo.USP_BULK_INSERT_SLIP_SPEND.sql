...
GO
CREATE PROC [dbo].[USP_BULK_INSERT_SLIP_SPEND]

/*
USP_BULK_INSERT_SLIP_SPEND '2018-08-06', '<XML />'
*/
...
DECLARE @SLIP_ID INT;
SET @SLIP_ID = (SELECT ISNULL(MAX(SLIP_ID),0) + 1 FROM ACC_SLIP_SPEND);
...
WITH (  
	...
	SPEND_TYPE VARCHAR(1000) './SpendType',
	SEND_DATE VARCHAR(1000) './SendDate',
	P_TYPE VARCHAR(1000) './PType'
) A



INSERT INTO ACC_SLIP_SPEND
(
	SLIP_ID, ROW_ID, ROW_NO, NO_TAX, CD_PC, CD_WDEPT, NO_DOCU, NO_DOLINE, CD_COMPANY, ID_WRITE, CD_DOCU, DT_ACCT, 
	...
	TP_EVIDENCE, PREV_SLIP_ID, NEXT_SLIP_ID, RESV_NO, PAY_SEQ, GROUP_KEY, USE_YN, CREATE_DATE, CREATE_USER, EXTRA, SPEND_TYPE, 
	SEND_DATE, P_TYPE
)
SELECT @SLIP_ID, ROW_ID, ROW_NO, NO_TAX, CD_PC, CD_WDEPT, ROW_ID, NO_DOLINE, CD_COMPANY, ID_WRITE, CD_DOCU, DT_ACCT, 
ST_DOCU, TP_DRCR, CD_ACCT, CONVERT(DECIMAL,ISNULL(AMT, 0)), CD_PARTNER, NM_NOTE, CD_BIZAREA, CD_DEPT, CD_CC, CD_PJT, CD_EMPLOY, 
NO_BDOCU, NO_BDOLINE, TP_DOCU, NO_ACCT, CD_EXCH, RT_EXCH, AM_EX, TP_GUBUN, CD_MNGD1, NM_MNGD1, CD_MNGD2, NM_MNGD2, 
CD_MNGD3, NM_MNGD3, CD_MNGD4, NM_MNGD4, CD_MNGD5, NM_MNGD5, CD_MNGD6, NM_MNGD6, CD_MNGD7, NM_MNGD7, CD_MNGD8, NM_MNGD8, 
TP_EVIDENCE, PREV_SLIP_ID, NEXT_SLIP_ID, RESV_NO, PAY_SEQ, 'SPEND_' + GROUP_KEY, USE_YN, GETDATE(), CREATE_USER, EXTRA, SPEND_TYPE, 
SEND_DATE, P_TYPE
FROM #TMP_TABLE


SELECT @SLIP_ID AS [IDENTITY];
