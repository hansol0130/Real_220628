...
GO
CREATE PROC [dbo].[UPS_HTL_SALE_MONTH_BY_CITY2] 

  
--UPS_HTL_SALE_MONTH_BY_CITY2 'R', 'RMTK', '2019-02-01', '2019-12-28', '' 
...
SET @SQL = @SQL + ' GROUP BY CONVERT(VARCHAR(7), ' + @T_DATE + ', 121), B.CITY_CODE, B.CITY_NAME ' + CHAR(13)  
