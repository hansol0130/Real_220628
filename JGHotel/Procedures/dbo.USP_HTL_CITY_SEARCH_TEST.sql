...
GO
CREATE PROC [dbo].[USP_HTL_CITY_SEARCH_TEST]      
      
/*      
USP_HTL_CITY_SEARCH_TEST '오'      
*/      
...
SELECT TOP 20 CITY_CODE, CITY_NAME, NATION_NAME, SORT1, SORT2, SORT_ORDER
INTO #TMP_CITY
FROM (      
 SELECT CITY_CODE, CITY_NAME, CITY_ENAME, NATION_NAME, NATION_ENAME, SORT_ORDER,      
 ...
 SELECT TOP 100 CITY_CODE, CITY_NAME, CITY_NAME, AREA_NAME + '*' AS NATION_NAME, AREA_ENAME AS NATION_ENAME, SORT_ORDER, 9999, 9999    
 FROM HTL_CODE_MAST_AREA    
 WHERE (UPPER(AREA_NAME) LIKE '%'+UPPER(@KEYWORD)+'%'      
