...
CREATE PROC [dbo].[USP_HTL_DOM_ROOM_PRICE_INSERT]

/*
USP_HTL_DOM_ROOM_PRICE_INSERT '900332', '2', '호텔형 더블 (10평)', 'UC', 'KKK6534', '
<ArrayOfDY>
  <DY>
    <CD>2014-12-24</CD>
    <NP>0</NP>
...
GROUP BY CHECK_IN_DATE, NET_PRICE, SALE_PRICE
...
A.NET_PRICE, A.SALE_PRICE, @AVAIL_TYPE, @UPDATE_USER, GETDATE(), @UPDATE_USER, GETDATE()
FROM #TMP_TABLE A
