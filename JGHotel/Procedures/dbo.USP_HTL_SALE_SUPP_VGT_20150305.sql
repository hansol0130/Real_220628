...
GO
CREATE PROC [dbo].[USP_HTL_SALE_SUPP_VGT_20150305]

/*
USP_HTL_SALE_SUPP_VGT '', 'R', '2015-02-01', '2015-02-28', ''
*/
...
SET @SQL = @SQL + 'TOTAL_AMT, SUPP_NET, PAY_AMT, (CASE WHEN SUPP_CODE IN (''HA'') THEN TOTAL_AMT ELSE TOTAL_AMT-SUPP_NET END) AS GROSS_COM_AMT, ' + CHAR(13)
SET @SQL = @SQL + '(CASE WHEN SUPP_CODE IN (''HA'') THEN TOTAL_AMT - CARD_COST ELSE NET_COM_AMT END) AS NET_COM_AMT, HOTEL_NAME ' + CHAR(13)
