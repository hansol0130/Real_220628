...
GO
CREATE PROC [dbo].[UPS_HTL_SALE_MONTH_BY_CITY]  

/*  
UPS_HTL_SALE_MONTH_BY_CITY 'RMTK', '2014-01-01', '2014-01-31'  
*/  
...
SET @SQL = @SQL + ' GROUP BY CONVERT(VARCHAR(7), A.CREATE_DATE, 121), B.CITY_CODE, B.CITY_NAME ' + CHAR(13)  
