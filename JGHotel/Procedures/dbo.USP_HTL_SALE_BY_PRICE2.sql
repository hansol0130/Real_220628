...
GO
CREATE PROC [dbo].[USP_HTL_SALE_BY_PRICE2]
    
/*    
USP_HTL_SALE_BY_PRICE2 'C', '2014-01-01', '2014-09-30'
*/    
...
SET @SQL = @SQL + ' CONVERT(VARCHAR(10), ' + @T_DATE + ', 121) >= '''+@DATE_FROM+''' AND CONVERT(VARCHAR(10), ' + @T_DATE + ', 121) < CONVERT(DATETIME, '''+@DATE_TO+''') + 1 ' + CHAR(13)    
