...
GO
CREATE PROC [dbo].[USP_HTL_AUTOCANCEL_TYPE3]

/*
USP_HTL_AUTOCANCEL_TYPE3
*/
...
FROM (
	...
	(SELECT TOP 1 (CX_DATE_FROM)
	FROM HTL_RESV_CXL
	WHERE RESV_NO=A.RESV_NO AND CX_REF='JG'
	ORDER BY SEQ_NO) AS BEGIN_DATE
