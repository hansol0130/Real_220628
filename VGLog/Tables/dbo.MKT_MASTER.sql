...
CREATE TABLE [dbo].[MKT_MASTER](
	...
	[ATT_NAME] [varchar](500) NULL,
 CONSTRAINT [PK_MKT_MASTER] PRIMARY KEY CLUSTERED 
(
	[PRO_CODE] ASC,
	[PRO_TYPE] ASC
...
GO
ALTER TABLE [dbo].[MKT_MASTER] ADD  CONSTRAINT [DF_MKT_MASTER_AFF_CODE]  DEFAULT ('VG') FOR [AFF_CODE]
GO
